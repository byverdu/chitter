...
class User
	...
	property :user_name,   String, required: true, unique: true, message: "The name field can not be empty"

	attr_reader   :password
	attr_accessor :password_confirmation
	
	validates_confirmation_of :password, message: "There is some problems with your password"
